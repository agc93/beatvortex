import { MainPage, log, FlexLayout, Icon, actions } from 'vortex-api';
const { ListGroup, ListGroupItem, Panel, Button, Table, Breadcrumb } = require('react-bootstrap');
...
export class BeatModsList extends React.Component {
    ...
    public render() {
        ...
        const { selected, mods, gameVersion } = this.state;
